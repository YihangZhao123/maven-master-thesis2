...
int read_fifo_DoubleType(circular_fifo_DoubleType* src,DoubleType* dst, size_t number);
...
int read_fifo_UInt16(circular_fifo_UInt16* src,UInt16* dst, size_t number);
